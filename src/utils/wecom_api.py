...
class WeComAPI:
    ...
    def create_space(self, space_name: str, auth_info: Optional[List[Dict]] = None) -> str:
        ...
        url = f"https://qyapi.weixin.qq.com/cgi-bin/wedrive/space_create"
    ...
    def list_files(self, space_id: str, father_id: str = "") -> List[Dict]:
        ...
        """
        token = self._get_access_token()
        url = f"https://qyapi.weixin.qq.com/cgi-bin/wedrive/file_list"
    ...
    def get_file_download_url(self, file_id: str) -> str:
        ...
        """
        token = self._get_access_token()
        url = f"https://qyapi.weixin.qq.com/cgi-bin/wedrive/file_download"
    ...
    def get_space_info(self, space_id: str) -> Dict:
        ...
        """
        token = self._get_access_token()
        url = f"https://qyapi.weixin.qq.com/cgi-bin/wedrive/space_info"
